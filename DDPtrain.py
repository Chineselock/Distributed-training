...
for epoch in range(num_epoch):
    ...
    for data in tqdm(train_loader):	
        ...
        my_context = model.no_sync if step % accumulation_steps != 0 else nullcontext
        with my_context():
